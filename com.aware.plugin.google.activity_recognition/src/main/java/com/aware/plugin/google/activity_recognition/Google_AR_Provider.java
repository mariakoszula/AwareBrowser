...
public class Google_AR_Provider extends ContentProvider {
    ...
    public static final String[] TABLES_FIELDS = {
            ...
            Google_Activity_Recognition_Data.DEVICE_ID + " text default ''," +
                    Google_Activity_Recognition_Data.SESSION_ID + " text default ''," +
    ...
    public boolean onCreate() {
        ...
        gARMap.put(Google_Activity_Recognition_Data.SESSION_ID,
                Google_Activity_Recognition_Data.SESSION_ID);
